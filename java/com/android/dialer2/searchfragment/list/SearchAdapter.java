...
import com.android.dialer2.searchfragment.cp2.SearchContactViewHolder;
import com.android.dialer2.searchfragment.directories.DirectoryContactViewHolder;
import com.android.dialer2.searchfragment.list.SearchCursorManager.RowType;
import com.android.dialer2.searchfragment.nearbyplaces.NearbyPlaceViewHolder;
...
public final class SearchAdapter extends RecyclerView.Adapter<ViewHolder> {
  ...
  private static class LocationPermissionViewHolder extends RecyclerView.ViewHolder {
    ...
    LocationPermissionViewHolder(
      ...
      itemView
          .findViewById(
              com.android.dialer2.searchfragment.nearbyplaces.R.id.location_permission_allow)
          .setOnClickListener(allowClickListener);
      itemView
          .findViewById(
              com.android.dialer2.searchfragment.nearbyplaces.R.id.location_permission_dismiss)
